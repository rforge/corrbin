...
\mbox{}\verb@#'@\\
\mbox{}\verb@#'The \code{multiCA.test} function performs a multinomial generalization of the @\\
...
\mbox{}\verb@#' @{\tt @}\verb@importFrom stats terms xtabs@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@  Tt <-  X[nonz] / sqrt(pdot[nonz] * (1-pdot[nonz])* s2)@\\
\mbox{}\verb@  CAT <- Tt^2@\\
\mbox{}\verb@  CAT.p.value <- pchisq(CAT, df=1, lower.tail=FALSE)@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  #overall test@\\
\mbox{}\verb@  if (full || sum(pdot) >= 1){@\\
\mbox{}\verb@    W <- ( sum(X[nonz]^2 / pdot[nonz])) / s2@\\
\mbox{}\verb@  } else {@\\
\mbox{}\verb@    W <- (sum(X)^2 / (1-sum(pdot)) + sum(X[nonz]^2 / pdot[nonz])) / s2@\\
\mbox{}\verb@  }@\\
\mbox{}\verb@@\\
\mbox{}\verb@  df <- length(outcomes) - full@\\
\mbox{}\verb@  p.value <- pchisq(W, df=df, lower.tail=FALSE)@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  @\hbox{$\langle\,${\itshape Calculate correlation and contrast matrices}\nobreak\ {\footnotesize \NWlink{nuweb8b}{8b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@  res <- list(statistic = W, parameter = df, p.value = p.value, @\\
\mbox{}\verb@              indiv.statistics = Tt, indiv.p.value = CAT.p.value,@\\
\mbox{}\verb@              sigma0 = Sigma0, contrast = C)@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@.multiCA.test@\nobreak\ \NWlink{nuweb3}{3}\NWlink{nuweb6a}{, 6a}\NWlink{nuweb10b}{, 10b}\NWlink{nuweb11}{, 11}\NWlink{nuweb12c}{, 12c}\NWlink{nuweb?}{, ?}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\mbox{}\verb@#'@{\tt @}\verb@param p.adjust.method character string defining the correction method for individual outcome p-values. Defaults to "closed.set" when \code{length(outcomes)<=3}, and "Holm-Shaffer" otherwise.@\\
\mbox{}\verb@#'@{\tt @}\verb@export@\\
\mbox{}\verb@#' @{\tt @}\verb@importFrom utils str@\\
\mbox{}\verb@#' @{\tt @}\verb@importFrom multcomp glht adjusted parm@\\
\mbox{}\verb@@\\
\mbox{}\verb@multiCA.test.default <- function(x, scores=1:ncol(x), outcomes=1:nrow(x),@\\
\mbox{}\verb@  p.adjust.method=c("none","closed.set","Holm-Shaffer", "single-step", "Westfall"),...){@\\
...
\mbox{}\verb@ @\\
\mbox{}\verb@  W <- c(W = testres$statistic)@\\
...
\mbox{}\verb@    else p.adjust.method <- "Holm-Shaffer"@\\
\mbox{}\verb@  } else {@\\
...
\mbox{}\verb@  } else if (p.adjust.method=="Holm-Shaffer") {@\\
\mbox{}\verb@    @\hbox{$\langle\,${\itshape Holm-Shaffer adjustment}\nobreak\ {\footnotesize \NWlink{nuweb5b}{5b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@  } else if (p.adjust.method %in% c("single-step", "Westfall")) {@\\
\mbox{}\verb@    @\hbox{$\langle\,${\itshape glht adjustment}\nobreak\ {\footnotesize \NWlink{nuweb8a}{8a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@  }@\\
...
\NWtarget{nuweb5b}{} $\langle\,${\itshape Holm-Shaffer adjustment}\nobreak\ {\footnotesize {5b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb8a}{} $\langle\,${\itshape glht adjustment}\nobreak\ {\footnotesize {8a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@    if (full.set) {@\\
\mbox{}\verb@        testparm <- parm(testres$indiv.statistics[-1], testres$sigma0[-1,-1])@\\
\mbox{}\verb@    } else {@\\
\mbox{}\verb@        testparm <-  parm(testres$indiv.statistics, testres$sigma0)                            @\\
\mbox{}\verb@        }@\\
\mbox{}\verb@    g1 <- glht(model = testparm,  linfct = testres$contrast)@\\
\mbox{}\verb@    indiv.res <- summary(g1, test=adjusted(type=p.adjust.method,...))$test$pvalues@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\mbox{}\verb@#' outcome probabilities \code{pmatrix} can be specified, or exactly two of the parameters @\\
\mbox{}\verb@#' \code{p.ave}, \code{slopes}, \code{p.start}, and \code{p.end} must be specified, while @\\
\mbox{}\verb@#' @\\
...
\mbox{}\verb@#' @{\tt @}\verb@export@\\
\mbox{}\verb@#' @{\tt @}\verb@importFrom stats pchisq qchisq weighted.mean@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb12a}{} $\langle\,${\itshape Calculate p.ave and slopes from specification}\nobreak\ {\footnotesize {12a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
