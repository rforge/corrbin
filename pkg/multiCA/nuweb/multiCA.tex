...
\mbox{}\verb@  }@\\
\mbox{}\verb@  names(Tt) <- "W"@\\
\mbox{}\verb@@\\
\mbox{}\verb@  df <- length(outcomes) - full@\\
\mbox{}\verb@  names(df) <- "df"@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb2b}{2b}\NWlink{nuweb?}{, ?}.
...
\item \verb@"../R/multiCA.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb2b}{2b}\NWlink{nuweb?}{, ?}.
}
\end{list}}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@multiCA.test.default@: \underline{\NWlink{nuweb2b}{2b}}.
